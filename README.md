...
**从 v1.5.0 升级：** 旧版没有内置更新入口，需要先从 Releases 手动安装最新版一次。从 v1.6.1 开始可以在应用内检查后续版本，下载后启动更新安装。Windows 打开安装向导；Mac 打开 DMG 后，将新版拖入“应用程序”覆盖旧版。安装包目前尚未配置发布者代码签名，系统仍可能提示验证开发者。
