...
[项目仓库](https://github.com/Brclio/brclio-xhs-media-downloader) · [下载 v1.5.0 安装包](https://github.com/Brclio/brclio-xhs-media-downloader/releases/tag/v1.5.0)
...
- 将帖子分别保存到用户选择的文件夹，包含原图、实况动态片段、视频和文案。
- 暂停、继续、取消、失败重试、重启恢复；已成功保存并通过文件检查的内容自动跳过。
