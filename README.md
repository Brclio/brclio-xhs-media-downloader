...
**v1.8.3–v1.8.6 的 Mac 升级提醒：** 旧版自带更新助手可能让新应用或恢复的旧应用直接退出，发布新版不会改写旧助手。请下载 [v1.8.8 完整 DMG](docs/releases/v1.8.8.md)，等待现有安装结束，完全退出旧版后拖入原安装位置并选择替换，再从“应用程序”手动打开。v1.8.7 可正常使用应用内更新。账号、任务记录和已下载文件无需删除。
